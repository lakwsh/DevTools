...
class ExtractPluginCommand extends \pocketmine\command\PluginCommand{
	...
	public function execute(CommandSender $sender,$commandLabel,array $args){
		if(!$this->getPlugin()->isEnabled()) return false;
		...
		if(file_exists($folderPath)) $sender->sendMessage('Plugin already exists,overwriting...');
